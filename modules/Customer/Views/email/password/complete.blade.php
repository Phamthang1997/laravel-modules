@include('customer::email.components.header', ['title' =>'Password is changed'])
            ...
            <table style="max-width:670px;  margin:0 auto;" width="100%" border="0"
                ...
                <tr>
                    <td style="text-align:center;">
                        <a href="{{ route('customer.index') }}" title="logo" target="_blank">
                            <img width="60" src="{{ asset('customer/assets/image/spot-illustrations/22_2.png') }}" title="logo" alt="logo">
                        </a>
                    </td>
                </tr>
                <tr>
                ...
                @include('customer::email.components.footer')
            </table>
        </td>
    </tr>
</table>

        ...
        <div class="ecommerce-topbar">
            <nav class="navbar navbar-expand-lg navbar-light px-0">
                <div class="row gx-0 gy-2 w-100 flex-between-center">
                    <div class="col-auto"><a class="text-decoration-none" href="{{ route('customer.index') }}">
                            <div class="d-flex align-items-center"><img src="{{ asset('customer/assets/image/icons/logo.png') }}" alt="phoenix" width="27" />
                    ...
                    <div class="col-auto order-md-1">
                        <ul class="navbar-nav navbar-nav-icons flex-row me-n2">
                                                        ...
                                                        <div class="border-300">
                                                            <div class="px-2 px-sm-3 py-3 border-300 notification-card position-relative read border-bottom">
                                                                <div class="d-flex align-items-center justify-content-between position-relative">
                                                                    <div class="d-flex">
                                                                        <div class="avatar avatar-m status-online me-3"><img class="rounded-circle" src="{{ asset('customer/assets/image/team/avatar.webp') }}" alt="" /></div>
                                                            ...
                                                            <div class="px-2 px-sm-3 py-3 border-300 notification-card position-relative unread border-bottom">
                                                                <div class="d-flex align-items-center justify-content-between position-relative">
                                                                    <div class="d-flex">
                                                                        <div class="avatar avatar-m status-online me-3"><img class="rounded-circle avatar-placeholder" src="{{ asset('customer/assets/image/team/avatar.webp') }}" alt="" /></div>
                                                                        <div class="flex-1 me-sm-3">
                                                                            <h4 class="fs--1 text-black">Jessie Samson</h4>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end navbar-dropdown-caret py-0 dropdown-profile shadow border border-300 mt-2" aria-labelledby="navbarDropdownUser">
                                        <div class="card position-relative border-0">
                                            <div class="card-body p-0">
                                                <div class="text-center pt-4 pb-3">
                                                    <div class="avatar avatar-xl ">
                                                        <img class="rounded-circle " src="{{ asset('customer/assets/image/team/avatar.webp') }}" alt="" />
                                                    </div>
                                            ...
                                            <div class="card-footer p-0 border-top">
                                                ...
                                                <hr />
                                                <div class="px-3"> <a class="btn btn-phoenix-secondary d-flex flex-center w-100" href="{{ route('customer.logout') }}"> <span class="me-2" data-feather="log-out"> </span>Sign out</a></div>
                            ...
                            @guest('customer')
                                <li class="nav-item">
                                    <a class="nav-link px-2" href="{{ route('customer.login') }}">
                                        <span class="fw-bold">Sign in</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link px-2" href="{{ route('customer.create') }}">

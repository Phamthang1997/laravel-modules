...
@section('content')
    ...
    <!--    Main navbar-->
    @include('customer::components.sidenav')
    ...
    <div class="ecommerce-homepage pt-5 mb-9">
        ...
        <!-- ============================================-->
        <!-- <section> begin ============================-->
        @include('customer::page.homepage.scrollbar')
        <!-- <section> close ============================-->
        <!-- ============================================-->
        ...
        <section class="py-0 px-xl-3">
            <div class="container px-xl-0 px-xxl-3">
                <div class="row g-3 mb-9">
                    <div class="col-12">
                        <div class="whooping-banner w-100 rounded-3 overflow-hidden">
                            <div class="bg-holder z-index--1 product-bg" style="background-image:url({{ asset('customer/assets/image/e-commerce/whooping_banner_product.png') }});background-position: bottom right;"></div>
                            <!--/.bg-holder-->
                            <div class="bg-holder z-index--1 shape-bg" style="background-image:url({{ asset('customer/assets/image/e-commerce/whooping_banner_shape_2.png') }});background-position: bottom left;"></div>
                            <!--/.bg-holder-->
                    ...
                    <div class="col-12 col-xl-6">
                        <div class="gift-items-banner w-100 rounded-3 overflow-hidden">
                            <div class="bg-holder z-index--1 banner-bg" style="background-image:url({{ asset('customer/assets/image/e-commerce/gift-items-banner-bg.png') }});"></div>
                            <!--/.bg-holder-->
                    ...
                    <div class="col-12 col-xl-6">
                        <div class="best-in-market-banner d-flex h-100 px-4 px-sm-7 py-5 px-md-11 rounded-3 overflow-hidden">
                            <div class="bg-holder z-index--1 banner-bg" style="background-image:url({{ asset('customer/assets/image/e-commerce/best-in-market-bg.png') }});"></div>
                            <!--/.bg-holder-->
                            <div class="row align-items-center w-sm-100">
                                ...
                                <div class="col-4"><img class="w-100 w-sm-75" src="{{ asset('customer/assets/image/e-commerce/5.png') }}" alt=""></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row g-4 mb-6">
                    <div class="col-12 col-lg-9 col-xxl-10">
                        ...
                        <div class="swiper-theme-container products-slider">
                            <div class="swiper swiper-container theme-slider" data-swiper='{"loop":true,"autoplay":{"delay": 2000},"slidesPerView":1,"spaceBetween":16,"breakpoints":{"450":{"slidesPerView":2,"spaceBetween":16},"768":{"slidesPerView":3,"spaceBetween":20},"1200":{"slidesPerView":4,"spaceBetween":16},"1540":{"slidesPerView":5,"spaceBetween":16}}}'>
                                            ...
                                            <div class="d-flex flex-column justify-content-between h-100">
                                                <div>
                                                    <div class="border border-1 rounded-3 position-relative mb-3">
                                                        ...
                                                        <img class="img-fluid" src="{{ asset('customer/assets/image/products/6.png') }}" alt="" />
                                                    </div>
                                            ...
                                            <div class="d-flex flex-column justify-content-between h-100">
                                                <div>
                                                    <div class="border border-1 rounded-3 position-relative mb-3">
                                                        ...
                                                        <img class="img-fluid" src="{{ asset('customer/assets/image/products/1.png') }}" alt="" />
                                            ...
                                            <div class="d-flex flex-column justify-content-between h-100">
                                                <div>
                                                    <div class="border border-1 rounded-3 position-relative mb-3">
                                                        ...
                                                        <img class="img-fluid" src="{{ asset('customer/assets/image/products/2.png') }}" alt="" />
                                                    </div>
                                                    <a class="stretched-link" href="product-details.html">
                                            ...
                                            <div class="d-flex flex-column justify-content-between h-100">
                                                <div>
                                                    <div class="border border-1 rounded-3 position-relative mb-3">
                                                        ...
                                                        <img class="img-fluid" src="{{ asset('customer/assets/image/products/3.png') }}" alt="" />
                                                    </div>
                                                    <a class="stretched-link" href="product-details.html">
                                            ...
                                            <div class="d-flex flex-column justify-content-between h-100">
                                                <div>
                                                    <div class="border border-1 rounded-3 position-relative mb-3">
                                                        ...
                                                        <img class="img-fluid" src="{{ asset('customer/assets/image/products/5.png') }}" alt="" />
                                                    </div>
                                                    <a class="stretched-link" href="product-details.html">
                    ...
                    <div class="col-lg-3 d-none d-lg-block col-xxl-2">
                        <div class="h-100 position-relative rounded-3 overflow-hidden">
                            <div class="bg-holder" style="background-image:url({{ asset('customer/assets/image/e-commerce/4.png') }});"></div>
                            <!--/.bg-holder-->
                        </div>
                    </div>
                    <div class="col-12 d-lg-none"><a href="#!"><img class="w-100 rounded-3" src="{{ asset('customer/assets/image/e-commerce/6.png') }}" alt="" /></a></div>
                </div>
                <div class="mb-6">
                    <div class="d-flex flex-between-center mb-3">
                    ...
                    <div class="swiper-theme-container products-slider">
                        <div class="swiper swiper-container theme-slider" data-swiper='{"loop":true,"autoplay":{"delay": 2000},"slidesPerView":1,"spaceBetween":16,"breakpoints":{"450":{"slidesPerView":2,"spaceBetween":16},"576":{"slidesPerView":3,"spaceBetween":20},"768":{"slidesPerView":4,"spaceBetween":20},"992":{"slidesPerView":5,"spaceBetween":20},"1200":{"slidesPerView":6,"spaceBetween":16}}}'>
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="position-relative text-decoration-none product-card h-100">
                                        <div class="d-flex flex-column justify-content-between h-100">
                                        ...
                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div>
                                                <div class="border border-1 rounded-3 position-relative mb-3">
                                                    ...
                                                    <img class="img-fluid" src="{{ asset('customer/assets/image/products/7.png') }}" alt="" />
                                                </div>
                                                <a class="stretched-link" href="product-details.html">
                                        ...
                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div>
                                                <div class="border border-1 rounded-3 position-relative mb-3">
                                                    ...
                                                    <img class="img-fluid" src="{{ asset('customer/assets/image/products/12.png') }}" alt="" />
                                                </div>
                                                <a class="stretched-link" href="product-details.html">
                                ...
                                <div class="swiper-slide">
                                    <div class="position-relative text-decoration-none product-card h-100">
                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div>
                                                <div class="border border-1 rounded-3 position-relative mb-3">
                                                    <button class="btn rounded-circle p-0 d-flex flex-center btn-wish z-index-2 d-toggle-container btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove from wishlist">
                                                        <span class="fas fa-heart"></span>
                                                    </button>
                                                    <img class="img-fluid" src="{{ asset('customer/assets/image/products/1.png') }}" alt="" />
                                                    <span class="badge bg-success fs--2 product-verified-badge">Verified
                                        ...
                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div>
                                                <div class="border border-1 rounded-3 position-relative mb-3">
                                                    ...
                                                    <img class="img-fluid" src="{{ asset('customer/assets/image/products/16.png') }}" alt="" />
                                                </div>
                                                <a class="stretched-link" href="product-details.html">
                                        ...
                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div>
                                                <div class="border border-1 rounded-3 position-relative mb-3">
                                                    ...
                                                    <img class="img-fluid" src="{{ asset('customer/assets/image/products/10.png') }}" alt="" />
                                                </div>
                                                <a class="stretched-link" href="product-details.html">
                                        ...
                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div>
                                                <div class="border border-1 rounded-3 position-relative mb-3">
                                                    ...
                                                    <img class="img-fluid" src="{{ asset('customer/assets/image/products/8.png') }}" alt="" />
                                                </div>
                                                <a class="stretched-link" href="product-details.html">
                                        ...
                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div>
                                                <div class="border border-1 rounded-3 position-relative mb-3">
                                                    ...
                                                    <img class="img-fluid" src="{{ asset('customer/assets/image/products/25.png') }}" alt="" />
                                                </div>
                                                <a class="stretched-link" href="product-details.html">
                                        ...
                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div>
                                                <div class="border border-1 rounded-3 position-relative mb-3">
                                                    ...
                                                    <img class="img-fluid" src="{{ asset('customer/assets/image/products/27.png') }}" alt="" />
                                                </div>
                                                <a class="stretched-link" href="product-details.html">
                                        ...
                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div>
                                                <div class="border border-1 rounded-3 position-relative mb-3">
                                                    ...
                                                    <img class="img-fluid" src="{{ asset('customer/assets/image/products/26.png') }}" alt="" />
                                                </div>
                                                <a class="stretched-link" href="product-details.html">
                                        ...
                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div>
                                                <div class="border border-1 rounded-3 position-relative mb-3">
                                                    ...
                                                    <img class="img-fluid" src="{{ asset('customer/assets/image/products/18.png') }}" alt="" />
                                                </div>
                                                <a class="stretched-link" href="product-details.html">
                                        ...
                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div>
                                                <div class="border border-1 rounded-3 position-relative mb-3">
                                                    ...
                                                    <img class="img-fluid" src="{{ asset('customer/assets/image/products/17.png') }}" alt="" />
                                                </div>
                                                <a class="stretched-link" href="product-details.html">
                                        ...
                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div>
                                                <div class="border border-1 rounded-3 position-relative mb-3">
                                                    ...
                                                    <img class="img-fluid" src="{{ asset('customer/assets/image/products/24.png') }}" alt="" />
                                                </div>
                                                <a class="stretched-link" href="product-details.html">
                ...
                <div class="row flex-center mb-15 mt-11 gy-6">
                    <div class="col-auto">
                        <img class="d-dark-none" src="{{ asset('customer/assets/image/spot-illustrations/light_30.png') }}" alt="" width="305" />
                        <img class="d-light-none" src="{{ asset('customer/assets/image/spot-illustrations/dark_30.png') }}" alt="" width="305" />
                    </div>
                    <div class="col-auto">
    ...
    <!--    Main information-->
    @include('customer::components.information')
@endsection
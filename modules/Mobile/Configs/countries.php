...
// These are sorted by the native name, which is the order you might show them in a countries selector.
// Regional locala are sorted by their base name, so "Japan" sorts as "JP"
